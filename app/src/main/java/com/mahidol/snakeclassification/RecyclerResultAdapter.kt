...
class RecyclerResultViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
...
class RecyclerResultAdapter(private val infoData: ArrayList<InfoData>, private val mContext: Context) :
